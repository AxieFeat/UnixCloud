...
//import net.unix.node.command.question.argument.primitive.QuestionBoolArgument
...
//    }
//
//    CloudInstaller.install()
//}
//
//private object CloudInstaller : KoinComponent {
//
...
//        terminal.start()
//
//        if (!UnixConfiguration.firstLoad) {
//            CloudInstance.start()
//            return
//        }
//
//        question(QuestionStringArgument()) {
//            create {
//                CloudLogger.info("Lets setup UnixCloud. Firstly set a name of this node.")
//            }
//
//            answer { name ->
//                close()
//                next(QuestionBoolArgument()) {
//                    create {
//                        CloudLogger.info("Node will use this name: $name.")
//                        CloudLogger.info("Now if you have several nodes you can connect this node to other")
//                        CloudLogger.info("or configure it as center of all nodes.")
//                        CloudLogger.info("Would you connect this node to other?")
//                    }
//
//                    answer { connect ->
//                        close()
...
//                            create {
//                                if(connect) {
//                                    CloudLogger.info("Set up ip of main node.")
//                                    return@create
//                                }
//
//                                CloudLogger.info("Set up ip of this node.")
//                            }
//
//                            answer { host ->
//                                close()
//                                CloudLogger.info("You have been setup UnixCloud,")
//                            }
//                        }
//                    }
//                }.start()
...
//}
//
//object CloudInstance : KoinComponent {
//
//    val uptime: Long
//        get() = System.currentTimeMillis() - unixStartTime
//
...
//}
//
//private fun registerNotSingleCommands() {
//
//    /*
//
//        /node
//            list - Список всех нод
//            info <node> - Информация о ноде
//
//     */
//    command("node") {
//
...
//}
//
//private fun registerNotCenterCommands(
